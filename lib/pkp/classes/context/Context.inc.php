...
class Context extends DataObject {
    ...
    /** Get the localized facultad of the context
    * @return string
    */
    function getLocalizedFacultad($preferredLocale = null) {
        return $this->getLocalizedSetting('facultad',$preferredLocale);
    }
    /**
    * Set the facultad of the context
    * @param $facultad string
    * @param $locale
    */
    function setFacultad($facultad, $locale = null) {
        return $this->setData('facultad', $facultad, $locale);
    }	
    /**
    * get the facultad of the context
    * @param $locale
    * @return string
    */
    function getFacultad($locale = null) {
        return $this->getSetting('facultad', $locale);
    }
    
    
    /** Get the localized tematica of the context
    * @return string
    */
    function getLocalizedTematica($preferredLocale = null) {
        return $this->getLocalizedSetting('tematica',$preferredLocale);
    }
    /**
    * Set the tematica of the context
    * @param $tematica string
    * @param $locale
    */
    function setTematica($tematica, $locale = null) {
        return $this->setData('tematica', $tematica, $locale);
    }	
    /**
    * get the tematica of the context
    * @param $locale
    * @return string
    */
    function getTematica($locale = null) {
        return $this->getSetting('tematica', $locale);
    }
