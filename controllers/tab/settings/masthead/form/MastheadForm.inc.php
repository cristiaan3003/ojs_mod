...
class MastheadForm extends ContextSettingsForm {
	...
	function __construct($wizardMode = false) {
        ...
        $this->addCheck(new FormValidatorLocale($this, 'tematica', 'required', 'manager.setup.form.journalTematicaRequired'));
	...
	function getLocaleFieldNames() {
		return array('facultad','tematica','name', 'acronym', 'abbreviation', 'description', 'editorialTeam', 'about');
	}
